  ...
  return (
    <Link to={"/Guild/"+props.address}>
      <div style={{position:"relative", left:"25px", width:"601px", height:"134px"}}>
        ...
        <Typography variant="caption" style={{textShadow:"-1px -1px #412220, 0px -0px #412220, -0px 0px #412220, 0px 0px #412220", color:"#7f433d", position:"absolute", left:"495px", top:"12px"}}>{props.address}</Typography>
        <Typography variant="caption" style={{textShadow:"-1px -1px #412220, 0px -0px #412220, -0px 0px #412220, 0px 0px #412220", color:"#7f433d", position:"absolute", left:"340px", top:"35px"}}>{"MEMBERSHIP NFTs (TOTAL: "+guildInfo.TotalMembershipNFTCnt+" / MY: "+userInfo.UserMembershipNFTCnt+")"}</Typography>
