...
const PollCard = (props:any) => {
  ...
  return (
    <Link to={"/Guild/"+id+"/Poll/"+props.id}>
      <div style={{position:"relative", left:"25px", width:"147px", height:"210px"}}>
        ...
        <Typography variant="h5" style={{textShadow:"0px 1px #000", color:"#fff", position:"absolute", left:"10px", top:"150px"}}>{shorten(props.hash, 8)}</Typography>
        <Typography variant="caption" style={{textShadow:"-1px -1px #412220, 0px -0px #412220, -0px 0px #412220, 0px 0px #412220", color:"#7f4334d", position:"absolute", left:"10px", top:"180px"}}>{props.done?"Done":"onVote"}</Typography>
      </div>
    </Link>
  );
};
