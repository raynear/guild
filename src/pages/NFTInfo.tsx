...
const NFTInfo = () => {
	...
	useEffect(() => {
		// guild.getCollectionAddress().then(address => {});
		setNFTInfo({contractAddress:config.CollectionNFTAddress, name:"sword", symbol:"SWRD"});
	},[]);
  ...
  return (
      ...
      <img alt="g" src={require("../image/nft-info-price.png")} style={{position:"absolute", left:"20px", top:"130px", width:"596px", height:"67px"}}/>
